...
public class MarkStationsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (username == null) {
                ...
                Request request1=user.getEngine().getData().getRequests().get(Integer.parseInt(request.getParameter("serialNumber")));
                Object[] arr = {user,request1.getFrom(),request1.getTo()};
