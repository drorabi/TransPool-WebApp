...
public class MarkRouteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (username == null) {
                ...
                Trip trip=user.getEngine().getData().getPlannedTrips().getTrips().get(Integer.parseInt(request.getParameter("serialNumber")));
                Object[] arr={trip.getRide(),user};
