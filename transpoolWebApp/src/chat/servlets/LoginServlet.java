...
import static chat.constants.Constants.USER_TYPE;
...
public class LoginServlet extends HttpServlet {
    ...
    private final String PROFILE_URL = "../profile/profile.html";
    private final String SIGN_IN_URL = "../signin/signin.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) {
            ...
            String typeOfUserFromParameter = request.getParameter(USER_TYPE);
            if (usernameFromParameter == null || usernameFromParameter.isEmpty() || typeOfUserFromParameter == null) {
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        String errorMessage = "Username " + usernameFromParameter + " already exists. Please enter a different username and try again.";
                        ...
                        userManager.addUser(usernameFromParameter, Integer.parseInt(typeOfUserFromParameter));
                        //set the username in a session so it will be available on each request
                        //the true parameter means that if a session object does not exists yet
                        //create a new one
                        request.getSession(true).setAttribute(Constants.USERNAME, usernameFromParameter);
                        request.getSession(true).setAttribute(USER_TYPE, typeOfUserFromParameter);
